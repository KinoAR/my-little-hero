...
let scene1 = {
  ...
  start: () => {
    ...
    waitInput("Well, begin your journey with new vigor " ++ hero.name ++ "!");
    ();
  },
  close: () => ()
};
...
let scene3 = {
  ...
  id: 3,
  player: hero,
  enemy: GameEnemy.cuteSoldier
};

let sceneWin = {
  name: "Win",
  id: 99,
  start: () => waitInput("You have won the battle."),
  close: () => ()
};
